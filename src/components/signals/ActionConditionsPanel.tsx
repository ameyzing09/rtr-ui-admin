    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-lg font-semibold text-gray-900">{availableCount}</span>
        ...
        {blockedCount > 0 && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="text-lg font-semibold text-gray-900">{blockedCount}</span>
      ...
      <div className="space-y-2">
        {actions.map((action) => {
          ...
          return (
            <Card key={action.actionCode} className="overflow-hidden">
              {/* Action Header */}
              <button
