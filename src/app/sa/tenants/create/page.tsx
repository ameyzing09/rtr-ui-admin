...
export default function CreateTenantPage() {
  ...
  const [nonValidationError, setNonValidationError] = useState<null | import('@/lib/errors/types').AppError>(null);
  ...
  // Centralized mutation for createTenant
  const {
    mutate: createTenant,
  ...
  return (
    <div className="p-8">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Wizard */}
        {nonValidationError && <ErrorBanner error={nonValidationError} onRetry={handleSubmit} />}
